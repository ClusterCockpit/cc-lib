...
func (r *RedfishReceiver) readThermalMetrics(
	...
	for _, temperature := range thermal.Temperatures {
		...
		y, err := lp.NewMessage("temperature", tags, meta,
	...
	for _, fan := range thermal.Fans {
		...
		y, err := lp.NewMessage("fan_speed", tags, meta,
			map[string]interface{}{
				"value": value,
			},
			timestamp)
...
func (r *RedfishReceiver) readPowerMetrics(
	...
	for _, pc := range power.PowerControl {
		...
		for name, value := range metrics {
			...
			y, err := lp.NewMessage(name, tags, meta,
				map[string]interface{}{
					"value": value,
				},
				timestamp)
...
// 		y, err := lp.NewMessage(namePower, tags, metaPower,
// 			map[string]interface{}{
...
// 		y, err := lp.NewMessage(nameThermal, tags, metaThermal,
// 			map[string]interface{}{

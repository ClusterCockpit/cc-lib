...
func (topo *Topology) InitTopologyMaps() {
	if topo.hwthreadToSocket == nil || topo.hwthreadToCore == nil ||
		topo.hwthreadToMemoryDomain == nil || topo.coreToSocket == nil ||
		topo.memoryDomainToSocket == nil || topo.coresPerSocket == nil {
